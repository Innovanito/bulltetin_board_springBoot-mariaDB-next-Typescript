...
//        int nowPage = pageable.getPageNumber() + 1; 위 코드와 이 코드는 같은 말임
    ...
    public String boardUpdate(@PathVariable("id") Integer id, Board board, Model model, MultipartFile file) throws Exception {
        ...
        model.addAttribute("message", "글 수정이 완료됨.");
        model.addAttribute("searchUrl", "/board/list");

        return "message";
    }

    @GetMapping("/board/write2") //localhost:8080/board/write
    public String boardWriterForm2() {
        return "1";
    }
}
